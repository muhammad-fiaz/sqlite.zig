...
description: Use raw SQL to alter table structure with add, rename, and drop column operations.
---

# Raw ALTER TABLE

This example demonstrates using raw SQL `ALTER TABLE` statements to modify a table's structure. It covers adding a column, renaming a column, dropping a column, and renaming the table itself.
